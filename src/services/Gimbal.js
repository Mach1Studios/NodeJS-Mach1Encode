 ...
 *
 * @see {@link https://github.com/marquizzo/three-gimbal}
 */
export default class Gimbal {
  ...
  /**
   * Enabling gimbal: start listening to devise orientation changes [addEventListener]
   */
  enable() {
  ...
  /**
   * Disabling gimbal: stops listening to device orientation changes
   */
  disable() {
  ...
  /**
   *  Recalibrates gimbal axes, so current phone orientation is the rotational origin;
  ...
  /**
   * Performs all necessary calculations, should be called once per frame
   */
  update() {
